...
from page_objects.registation.registation_object import RegistrationPage
from page_objects.shop.shop_object import ShopPage


# 第一个场景
@scenario("shop/shop_order_t_shirt.feature", '我按照购物流程进行下单, 新用户注册等操作')
...
# 第二场景
@scenario("shop/shop_order_t_shirt.feature", '进入首页后, 查看附件数量')
